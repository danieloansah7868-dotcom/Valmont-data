    ...
    m.innerHTML = `
      <div class="side-drawer" onclick="event.stopPropagation()">
        ...
        <div class="drawer-menu">
          <a class="menu-item" href="history.html" style="text-decoration:none">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"></circle><polyline points="12 7 12 12 15.5 14"></polyline></svg>
            Purchase History
          </a>
