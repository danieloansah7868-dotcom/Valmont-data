...
| `assets/img/valmont-data-logo.png` | **Official brand banner** — navy hexagon + orange-gradient V monogram and "VALMONT DATA" wordmark (VALMONT white · DATA orange), per the consolidated Valmont group identity; header/nav logo, transparent |
| `assets/img/valmont-data-favicon.png` | **Official brand favicon** — navy `#0b1a38` hexagon with the orange-gradient V monogram; used for all favicon/apple-touch-icon links and manifest.json icons |
